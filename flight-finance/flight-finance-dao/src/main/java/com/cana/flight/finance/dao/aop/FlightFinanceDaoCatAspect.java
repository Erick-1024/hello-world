package com.cana.flight.finance.dao.aop;
...
@Aspect
public class FlightFinanceDaoCatAspect extends AbstractCatMonitorAspect {

	@Override
	@Pointcut("execution(* com.cana.flight.finance.dao.mapper..*.*(..))")
