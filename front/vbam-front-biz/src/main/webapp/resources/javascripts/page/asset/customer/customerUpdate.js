...
$(function() {
	...
	var validator = $("#updateCustomer").kendoValidator({
		rules: {
	...
	$("#submit").click(function() {
		...
		$.ajax({
		    type : "POST",
			url : basepath + "/asset/customer/customerUpdateFormDate",
