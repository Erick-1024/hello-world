...
function exportCountReport() {
	...
	window.location.href = basepath + "/report/repayment/exportRepaymentCountReport?startTime=" + startTime + "&endTime=" + endTime + "&businessProduct=" + businessProduct;
