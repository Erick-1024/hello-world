    ...
    $("#monitorInfo-grid").kendoGrid({
        ...
        dataSource:{
            ...
            transport : {
				...
				url: basepath + "/yundaex/earlywarning/query/informationList"
			}
        },
        serverPaging: true,
		serverSorting: true,
        ...
        columns: [{
            ...
            template: function(data) {
            	if(adjuestAuth) {
            		return '<a class="comRow-link" href="' + basepath + '/yundaex/earlywarning/adjustList?memberId=' + data.financeId + '&outCustomerId=' + data.outCustomerId + '">调整预警</a>';
            	} else {
            		return '';
            	}
            },
