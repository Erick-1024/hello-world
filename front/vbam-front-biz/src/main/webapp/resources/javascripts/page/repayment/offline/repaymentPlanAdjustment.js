		...
		$.ajax({
			...
			success: function(data){
				if(data.status == "SUCCESS"){
					...
					// 输入框 disable
					$("input[name='accountPrincipalForNewPlan']").attr("disabled",false);
					$("input[name='accountInterestForNewPlan']").attr("disabled",false);
					$("input[name='accountServiceChargeForNewPlan']").attr("disabled",false);
					$("input[name='overduePrincipalForNewPlan']").attr("disabled",false);
					$("input[name='overdueInterestForNewPlan']").attr("disabled",false);
					$("input[name='overdueServiceChargeForNewPlan']").attr("disabled",false);
					$("input[name='extensionChargeForNewPlan']").attr("disabled",false);
					$("input[name='overdueManagerFeeForNewPlan']").attr("disabled",false);
					$("input[name='paidEarlyRepaymentChargeForNewPlan']").attr("disabled",false);
