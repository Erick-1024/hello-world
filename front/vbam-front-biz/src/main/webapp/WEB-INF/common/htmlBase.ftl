I<#import "/template/menuUtils.ftl" as mu/>
...
<head lang="en">
    ...
    <script src="${host}/js/common/respond.js"></script>
    <![endif]-->
	...
	<script type="text/javascript">
		...
		<#if (currentUser())??>
			...
			var companyName = '${(currentUser().userData.companyName)!''}';
	            ...
	            <div class="wrap clearfix">
	                <div class="navLeft">
	                    ...
	                    <ul class="stairMenu">
							...
							<@mu.printYDMenu curTopMenu=curTopMenu curSubMenu=curSubMenu onlyShowMainMenu=onlyShowMainMenu/>
							<@mu.printVJMenu curTopMenu=curTopMenu curSubMenu=curSubMenu onlyShowMainMenu=onlyShowMainMenu/>
	                    	<@mu.printRPMenu curTopMenu=curTopMenu curSubMenu=curSubMenu onlyShowMainMenu=onlyShowMainMenu/>
	                    	<@mu.printPMLMenu curTopMenu=curTopMenu curSubMenu=curSubMenu onlyShowMainMenu=onlyShowMainMenu/>
	                    	<@mu.printBAIMenu curTopMenu=curTopMenu curSubMenu=curSubMenu onlyShowMainMenu=onlyShowMainMenu/>
	                    	<@mu.printSIMMenu curTopMenu=curTopMenu curSubMenu=curSubMenu onlyShowMainMenu=onlyShowMainMenu/>
	                    	<@mu.printMRMenu curTopMenu=curTopMenu curSubMenu=curSubMenu onlyShowMainMenu=onlyShowMainMenu/>
	                    	<@mu.printHSMenu curTopMenu=curTopMenu curSubMenu=curSubMenu onlyShowMainMenu=onlyShowMainMenu/>
	                    	<@mu.printSETMenu curTopMenu=curTopMenu curSubMenu=curSubMenu onlyShowMainMenu=onlyShowMainMenu/>
	                    </ul>
	                    </#if>
	                </div>
