                    ...
                    <table class="dlg-addStaff-table">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <select id="multiSelect-box-add" multiple="multiple" class="">
	                                <#if rolesIdAndName?exists>
                						<#list rolesIdAndName?keys as key> 
		                                    <option value=${key!''}>${rolesIdAndName[key]!''}</option>
                						</#list>
	                            ...
	                            <span id="validateForRoleAdd" class="k-widget k-tooltip k-tooltip-validation k-invalid-msg" data-for="multiSelect-box" role="alert" style="position: relative; top: 0px; left: 0px;display: none;">
                ...
                <li>
                    <table class="dlg-addStaff-table">
                        ...
                        <tr>
                            <th><span class="redFalg">*</span>所属角色</th>
                            <td>
                            	<select id="multiSelect-box" multiple="multiple" class="">
	                                <#if rolesIdAndName?exists>
                						<#list rolesIdAndName?keys as key> 
		                                    <option value=${key!''}>${rolesIdAndName[key]!''}</option>
                						</#list>
	                            ...
	                            <span id="validateForRole" class="k-widget k-tooltip k-tooltip-validation k-invalid-msg" data-for="multiSelect-box" role="alert" style="position: relative; top: 0px; left: 0px;display: none;">
									<span class="k-icon k-warning"> </span>
									请至少选择一个角色
								</span>
...
<script>
	...
	var permissionsAuth = ${authorizeKey("PM_EMPLOYEE_LIST_PERMISSIONS")?string("true", "false")};
</script>
