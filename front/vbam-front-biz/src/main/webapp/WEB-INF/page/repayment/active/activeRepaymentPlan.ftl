   ...
   <div class="whiteBg">
    	...
    	<form id="repayInfoSearch">
            <ul class="searchList clearfix">
                <li>
                    <table class="searchTab">
						...
						<tr>
                            <th>融资客户</th>
                            <td>
                                <input type="text"  style="width:262px;" name="financeCompany">
                            </td>
                        </tr>
                        <tr>
                            <th>结清状态</th>
                            <td>
                                <select class="selectWrap" data-role="dropdownlist"  style="width:262px;" id="settleStatus">
                ...
                <li>
                    <a id="search-repayment-plan-btn" class="form-search-link repay-search"  href="javascript:void(0);"><i class="searchIcon"></i>查询</a>
                    <#if authorizeKey('FM_ACTIVE_REPAYMENT_PLAN_EXPORT')>
                    	<a id="export-repayment-plan-btn" class="form-search-link repay-search" href="javascript:void(0);">导出</a>
                    </#if>
                </li>
            </ul>
        </form>
                ...
                <li>
                    <table class="searchTab">
						...
						<tr>
                            <th>资金方</th>
                            <td>
                                <input type="text"  style="width:262px;" name="factorCompany">
                            </td>
                        </tr>
                        <tr>
                            <th>结清状态</th>
                ...
                <li>
                    <table class="searchTab">
                        ...
                        <tr>
                            <th>放款编号</th>
                            <td>
                                <input type="text" style="width:264px"  name="loanNo">
                            </td>
                        </tr>
                        <tr>
                            <th>还 款 日</th>
