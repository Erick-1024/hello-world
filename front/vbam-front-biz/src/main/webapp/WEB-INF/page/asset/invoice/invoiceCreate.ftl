...
<@hb.htmlBase title="应收账款管理" jsFiles=["common/formValidator.js","page/asset/invoice/formValidatorRules.js","js/common/jquery.nav.js","js/common/business.js","page/asset/invoice/invoiceCreate.js"] cssFiles=["css/monitor.css","css/project.css"] localCssFiles=[] curTopMenu = "基础资产信息" curSubMenu = "应收账款管理" removeExtHeader = false removeExtFooter = true>
            ...
            <div class="client-hide-bg">
                <table class="client-tb">
                    ...
                    <tbody>
                     <tr>
                        <th>业务合同号</th>
                        <td><input type="text" style="width:150px;" id="businessContractNo">
                    ...
                    <tr>
                        ...
                        <td id="customerName" name="customerName"></td>
                        <th>币种</th>
                        <td id="currency" name="currency"></td>
                        <th>业务产品</th>
                        <input type="hidden" id = "businessProduct" name="businessProduct" value="" />
                        <td id="businessProductDesc"></td>
                        <td></td>
                    </tr>
                    </tbody>
                </table>
