...
<@hb.htmlBase title="放款信息导入" jsFiles=["page/asset/loan/loanInfoFromExcel.js","js/common/ajaxfileupload.js", "common/dateutil.js"] cssFiles=["css/project.css","css/monitor.css"] localCssFiles=[] 
...
<div class="pro-bg" style="background: #fff;">
            ...
            <table class="import-tb">
                ...
                <tr>
                    ...
                    <td style="text-align:right;">
                        <a class="repayment-link" href="${mediaserver}imageservice?mediaImageId=assetloaninfotemplatedownload&mediaType=download">放款信息模板下载</a>
                    </td>
                </tr>
                <tr>
                    <th valign="top" style="">放款信息导入</th>
                    <td>
                        <div class="import-up">
                             <input type="file" class="input-file" name="excel" id="photos" style="top:0;width:100px;z-index:10;">
                          
                            <a class="default-link confirm-link" id="uploadLoanInfoExcel" href="javascript:void(0);" style="position:absolute;left:0;">上传附件</a>
                        </div>
        ...
        <div class="im-text-box">
            ...
            <div class="monitor-grid" id="legalLoanInfoGridDiv"></div>
        </div>
        <div class="im-text-box">
            <div>&emsp;检查未通过放款信息</div>
            <div class="monitor-grid" id="illegalLoanInfoGridDiv"></div>
        </div>
