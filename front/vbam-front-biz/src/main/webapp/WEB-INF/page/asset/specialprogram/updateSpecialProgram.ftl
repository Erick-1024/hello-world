...
<@hb.htmlBase title="专项计划管理修改" jsFiles=["common/formValidator.js","page/asset/specialprogram/formValidatorRules.js","page/asset/specialprogram/specialProgramBusiness.js","page/asset/specialprogram/specialProgramManage.js","page/asset/specialprogram/updateSpecialProgram.js","common/dateutil.js","page/asset/customer/jquery.nav.js"] cssFiles=["css/monitor.css","css/project.css"] localCssFiles=[] 
    ...
    <form class="" id="specialProgram-update">
        <div class="left-nav">
            <ul id="client-nav">
			...
			<input type="hidden" name="id" id ="oldId" value="${specialProgramDTO.id!}">
        <div class="client-bg">
            <!--弹窗触发按钮 -->
            ...
            <div class="client-hide-bg">
                <table class="client-tb">
                    ...
                    <tr>
                        ...
                        <td><input type="text" style="width:200px;" class="" name="id" id ="specialProgramId" value="${specialProgramDTO.id!}"></td>
                        <th><span class="redFalg">*</span>专项计划名称</th>
                        <td><input type="text" style="width:200px;" class="" name="specialProgramName" id ="specialProgramName" value="${specialProgramDTO.specialProgramName!}"></td>
                    ...
                    <tr>
                        ...
                        <td><input type="text" style="width:200px;" class="datepicker startDate hasIcon" id ="estimateEstablishmentDate" name="estimateEstablishmentDate" value="${specialProgramDTO.estimateEstablishmentDate!}"></td>
                    ...
                    <tr>
                        ...
                        <td><input type="text" style="width:200px;" class="" id ="managerName" name="managerName" value="${specialProgramDTO.managerName!}"><span class="new-manual-text" style="display:none" id =""></span></td>
                        <th>律所</th>
                        <td><input type="text" style="width:200px;" class="" id ="lawFirmName" name="lawFirmName" value="${specialProgramDTO.lawFirmName!}"></td>
                        <th>会计事务所</th>
                        <td><input type="text" style="width:200px;" class="" id ="accountingFirmName" name="accountingFirmName" value="${specialProgramDTO.accountingFirmName!}"></td>
                        <td></td>
                    </tr>
                    <tr>
                        <th>监管银行</th>
                        <td><input type="text" style="width:200px;" class="" id ="supervisionBank" name="supervisionBank" value="${specialProgramDTO.supervisionBank!}"></td>
                        <th>托管银行</th>
                        <td><input type="text" style="width:200px;" class="" id ="custodianBank" name="custodianBank" value="${specialProgramDTO.custodianBank!}"></td>
                        <th>评级机构</th>
                        <td><input type="text" style="width:200px;" class="" id ="ratingAgency" name="ratingAgency" value="${specialProgramDTO.ratingAgency!}"></td>
                        <td></td>
                    </tr>
                    <tr>
                        <th>资产评估机构</th>
                        <td><input type="text" style="width:200px;" class="" id ="assetEvaluationAgency" name="assetEvaluationAgency" value="${specialProgramDTO.assetEvaluationAgency!}"></td>
                        <th></th>
                        <td></td>
                        <th></th>
                        <td></td>
            ...
            <div class="client-hide-bg">
                <div style="margin-top:15px;" class ="all-hide">
                            ...
                            <tbody>
                            	<#if specialProgramDTO.originators?exists >
				                    <#list specialProgramDTO.originators as originator>
							              ...
							              <th><input type="hidden" class="input-new" name="interests-tb" ></th>
							                <td>${originator.originatorName!}</td>
							             </tr>
				                    </#list>
			                    </#if>
                            </tbody>
                            ...
                            <tbody>
                            	<#if specialProgramDTO.serviceAgencys?exists >
				                    <#list specialProgramDTO.serviceAgencys as serviceAgency>
	                           			<tr class="client-add-tr">
							              <th><input type="hidden" class="input-new" name="asset-tb" ></th>
							                <td>${serviceAgency.serviceAgencyName!}</td>
							             </tr>
				                    </#list>
			                    </#if>
                            </tbody>
