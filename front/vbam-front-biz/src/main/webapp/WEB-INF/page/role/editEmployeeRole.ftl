...
<@hb.htmlBase title="编辑员工角色" jsFiles=["js/vendor/jquery.ztree.core-3.5.js","js/vendor/jquery.ztree.excheck-3.5.js","page/role/roleCommon.js","page/role/editEmployeeRole.js","facade/formValidatorRules.js","common/formValidator.js"] cssFiles=["css/roleManage.css","css/zTree.css"] localCssFiles=[] curTopMenu = "权限管理" curSubMenu = "员工角色">
<div class="main-container">
    <section class="whiteBg">
        <div class="createRole-wrap">
        	<div class="createRole-title">编辑员工角色</div>
            <form id="createRole" method="post" action="">
                <table class="createRole-form">
                    ...
                    <tr>
                        ...
                        <td><input class="roleNameCheck" id="roleName" name="roleName" value=${role.roleName} data-roleId=${role.id} type="text" style="width:200px;"/>
