...
<@hb.htmlBase title="审核列表" jsFiles=["page/account/apply/list.js","common/dateutil.js"] cssFiles=["css/account.css"] localCssFiles=[] 
	curTopMenu = "账户管理" curSubMenu = "审核列表" removeExtHeader = false removeExtFooter = false>
...
<script>
	var curSubMenu = "审核列表";
	var detailAuth = ${authorizeKey("AM_APPLY_DETAIL")?string("true", "false")};
	var reviewAuth = ${authorizeKey("AM_APPLY_REVIEW")?string("true", "false")};
</script>
</@hb.htmlBase>