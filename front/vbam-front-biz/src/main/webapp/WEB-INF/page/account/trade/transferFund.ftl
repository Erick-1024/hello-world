...
<@hb.htmlBase title="转账" jsFiles=["common/jquery.form.min.js","common/cana.util.js","facade/formValidatorRules.js","common/formValidator.js","page/account/trade/tradeForTransferFund.js"] cssFiles=["css/account.css"] localCssFiles=[] 
