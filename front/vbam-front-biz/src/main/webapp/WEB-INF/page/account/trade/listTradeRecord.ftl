                    ...
                    <table class="searchTab">
                        ...
                        <tbody>
	                        ...
	                        <tr>
	                            <th>交易户名</th>
	                            <td>
	                            	<input type="text" name="oppositeAccountName" id="oppositeAccountName" style="width: 185px;">
	                            </td>
	                        </tr>
	                        <tr>
                            	<th>业务流水号</th>
	                            <td>
	                            	<input type="text" name="businessSeq" id="businessSeq" style="width: 185px;">
	                            </td>
                        	</tr>
                        </tbody>
                    </table>
                    ...
                    <table class="searchTab">
                        ...
                        <tbody>
	                        <tr>
	                            <th>银行账号</th>
	                            <td>
	                            	<input type="text" name="accountNo" id="accountNo" class="bankCard" style="width: 264px;">
	                            </td>
	                        </tr>
	                        <tr>
	                            <th>交易账号</th>
	                            <td>
	                            	<input type="text" name="oppositeAccountNo" id="oppositeAccountNo" style="width: 264px;">
	                            </td>
	                        </tr>
	                        <tr>
	                        	<th>交易时间</th>
...
<script>
	...
	var relaunchingWithdrawAuth = ${authorizeKey("AM_ACCOUNT_RELAUNCHING_WITHDRAW")?string("true","false")};
</script>
</@hb.htmlBase>