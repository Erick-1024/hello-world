        ...
        <form class="monitor-form">
            <table class="monitor-table">
                ...
                <tr>
                    ...
                    <td>
                        <a class="status-normal status-default limit-status" href="javascript:void(0);" value="NORMAL">正常</a>
                        <a class="status-normal status-default limit-status" href="javascript:void(0);" value="FREEZE">冻结</a>
                        <a class="status-normal status-default limit-status" href="javascript:void(0);" value="DISABLED">停用</a>
                        <a class="status-normal status-default limit-status" href="javascript:void(0);" value="INACTIVE">未激活</a>
                        <a class="status-normal status-chk limit-status" href="javascript:void(0);" value="">全部</a>
                    </td>
                </tr>
                </tbody>
            </table>
