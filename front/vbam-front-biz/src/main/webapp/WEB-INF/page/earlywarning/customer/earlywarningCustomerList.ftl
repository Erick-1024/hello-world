...
<@hb.htmlBase title="贷后预警" jsFiles=["page/earlywarning/customer/earlywarningCustomerList.js", "common/cana.util.js", "js/common/warPublic.js"] cssFiles=["css/monitor.css","css/warning.css"] localCssFiles=[] 
curTopMenu = "真旅项目" curSubMenu = "预警" removeExtHeader = false removeExtFooter = false>

<div class="main-container">
    <section class="whiteBg">
        <@ctb.toolsBar "customer"/>
