...
<@hb.htmlBase title="预警" jsFiles=["page/earlywarning/review/list.js", "common/cana.util.js", "common/dateutil.js", "page/earlywarning/EventDetailContent.js", "js/common/warPublic.js"] cssFiles=["css/monitor.css","css/warning.css"] localCssFiles=[] 
...
<script>
	var auditAuth = ${authorizeKey("TZ_EARLYWARNING_REVIEW_AUDIT")?string("true", "false")};
</script>
