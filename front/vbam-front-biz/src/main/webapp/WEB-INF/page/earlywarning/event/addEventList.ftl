...
<@hb.htmlBase title="新增预警事件" jsFiles=["facade/formValidatorRules.js","common/formValidator.js", "page/earlywarning/event/addEventList.js", "common/judgeIE.js", "common/dateutil.js", "common/cana.util.js", "js/common/ajaxfileupload.js", "js/common/warPublic.js"] cssFiles=["css/monitor.css","css/warning.css"] localCssFiles=[] 
        ...
        <form class="monitor-form" onsubmit="return false;">
            <table class="monitor-table">
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" style="width:240px;" name="outCustomerName" outCustomerId>
                    </td>
            ...
            <form class="out-new-form">
                <table class="relieve-table">
                    ...
                    <tr>
                        <th>外部客户名称</th>
                        <td>
                        	<input style="width:240px;" type="text" id="outCustomerName">
                        </td>
                    </tr>
                    <tr>
                        <th>预警种类</th>
                        <td>
                            <select id="selectWrap" data-role="dropdownlist" style="width:160px;">
                            	<#list EarlywarningEventCategory?keys as key>
                            		<#if key != "SYSTEM">
                            			<option value="${key}">${EarlywarningEventCategory[key]}</option>
                            		</#if>
								</#list>
                            </select>
                        </td>
                    ...
                    <tr class="opt-before">
                        <th>执行金额</th>
                        <td>
                            <input type="text" placeholder="￥" class="moneyNum" style="width:160px;" name="amount" oninput="predictCourtExecution()" onpropertychange="predictCourtExecution()"> 元
                        </td>
                    </tr>
