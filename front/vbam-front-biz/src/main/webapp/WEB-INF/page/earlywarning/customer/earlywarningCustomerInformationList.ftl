...
<@hb.htmlBase title="预警信息" jsFiles=["page/earlywarning/customer/earlywarningCustomerInformationList.js", "common/dateutil.js", "js/common/warPublic.js"] cssFiles=["css/monitor.css","css/warning.css"] localCssFiles=[] 
...
<script>
	var adjuestAuth = ${authorizeKey("TZ_EARLYWARNING_INFORMATION_ADJUST")?string("true", "false")};
</script>
