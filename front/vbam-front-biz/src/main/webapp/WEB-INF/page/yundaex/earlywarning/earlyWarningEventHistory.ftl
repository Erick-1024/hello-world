...
<@hb.htmlBase title=titleName jsFiles=["page/yundaex/earlywarning/earlyWarningEventHistory.js", "page/yundaex/earlywarning/eventDetailContent.js", "common/dateutil.js", "common/cana.util.js", "js/common/warPublic.js"] cssFiles=["css/monitor.css","css/warning.css"] localCssFiles=[] 
        ...
        <form class="monitor-form">
            <table class="monitor-table">
                ...
                <tr>
                	...
                	<td earlywarningType=${currentEarlywarningEventCategory} type=${type}>${YundaexEarlywarningEventCategory[currentEarlywarningEventCategory]}</td>
...
<#include 'eventDetailTemplate.ftl'/>
