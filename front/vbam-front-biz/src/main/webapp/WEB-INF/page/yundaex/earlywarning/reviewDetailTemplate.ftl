<script id="earlywarningEventDetail_template" type="text/x-kendo-template">
    <div class="relieve-content">
        <table class="relieve-table">
            ...
            <tr>
                <th>预警种类</th>
                <td><span class="war-pan" name="earlywarningEventCategory"></span></td>
            </tr>
            <tr>
                <th>事件种类</th>
                <td><span class="war-pan" name="earlywarningEventSubCategory"></span><a class="relieve-status" href="javascript:void(0);">详情</a></td>
            </tr>
            <tr currentLevel>
                <th>预警状态</th>
