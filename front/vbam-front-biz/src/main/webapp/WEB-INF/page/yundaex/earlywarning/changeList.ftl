...
<@hb.htmlBase title="预警流水" jsFiles=["page/yundaex/earlywarning/changeList.js", "common/dateutil.js", "js/common/warPublic.js"] cssFiles=["css/monitor.css","css/warning.css"] localCssFiles=[] 
