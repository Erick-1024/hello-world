            ...
            <form id="createRole" method="post" action="">
                <table class="createRole-form">
                    ...
                    <tr>
                        ...
                        <td>
                        	<span id="roleName" class="incRole-val">
                        		<#list role.roleSearchResultDTOs as roleSearch>
                        			${roleSearch.roleName}<br/>
                        			<input type="hidden" class="roleId" value="${(roleSearch.id)!}">
                        		</#list>
                        	</span>
                        </td>
                    </tr>
