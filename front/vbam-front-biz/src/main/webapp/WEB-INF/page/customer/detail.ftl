        ...
        <div class="incUser-wrap">
            ...
            <div class="incUser-content">
                <table class="incUser-table">
                    ...
                    <tr>
                        ...
                        <td></td>
                        <td colspan="2">
                        	<a class="incUser-link" href="${mediaserver}imageservice?mediaImageId=${customerDetailDTO.contactIdentityCardFrontMediaId!}&mediaType=video" target="_blank">正面</a>
                        	<a class="incUser-link" href="${mediaserver}imageservice?mediaImageId=${customerDetailDTO.contactIdentityCardBackMediaId!}&mediaType=video" target="_blank">背面</a>
                        </td>
                    </tr>
                    <tr>
            ...
            <div class="incUser-content">
                <table class="incUser-table">
                    ...
                    <tr>
                        ...
                        <td><a class="incUser-link" href="${mediaserver}imageservice?mediaImageId=${customerDetailDTO.organizationCodeCertificateMediaId!}&mediaType=video" target="_blank">查看</a></td>
                    	<td>
                    ...
                    <tr>
                        ...
                        <td><a class="incUser-link" href="${mediaserver}imageservice?mediaImageId=${customerDetailDTO.businessLicenceMediaId!}&mediaType=video" target="_blank">查看</a></td>
                    	<td>
                    ...
                    <tr>
                        ...
                        <td><a class="incUser-link" href="${mediaserver}imageservice?mediaImageId=${customerDetailDTO.taxRegistrationCertificateMediaId!}&mediaType=video" target="_blank">查看</a></td>
                    	<td>
                    ...
                    <tr>
                        ...
                        <td></td>
                        <td>
                       		<a class="incUser-link" href="${mediaserver}imageservice?mediaImageId=${customerDetailDTO.legalPersonIdentityCardFrontMediaId!}&mediaType=video" target="_blank">正面</a>
                       		<a class="incUser-link" href="${mediaserver}imageservice?mediaImageId=${customerDetailDTO.legalPersonIdentityCardBackMediaId!}&mediaType=video" target="_blank">背面</a>
                        </td>
                        <td>
            ...
            <div class="incUser-content">
                <table class="incUser-table">
                    ...
                    <tr>
                        <td class="incUser-table-til" valign="top"><span class="redStar">*</span>用户所属角色</td>
                        <td colspan="3"><span id="roleName">
                        <#if customerDetailDTO.roleDTOList??>
                        	<#list customerDetailDTO.roleDTOList as roleDTO>
	                        	${roleDTO.roleName!}<br/>
                        	</#list>
                        </#if>
                        </span></td>
