...
<@hb.htmlBase title="待审核列表" jsFiles=["page/user/customerListPendingAudit.js","common/dateutil.js"] cssFiles=["css/userManage.css"] localCssFiles=[] 
	curTopMenu = "用户管理" curSubMenu = "待审核列表" removeExtHeader = false removeExtFooter = false>
...
<script>
	...
	var detailAuth = ${authorizeKey("UM_UNAUDIT_DETAIL")?string("true", "false")};
	var reviewAuth = ${authorizeKey("UM_UNAUDIT_AUDIT")?string("true", "false")};
</script>
