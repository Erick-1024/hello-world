<div class="userCenter-content">
                <table>
                    ...
                    <tr>
                        ...
                        <td>
                        	<a class="userCenter-link ori_look"  href="${mediaserver}imageservice?mediaImageId=${companyInfo.organizationCodeCertificateMediaId!}&mediaType=video" target="_blank">查看</a>
                    ...
                    <tr>
                        ...
                        <td>
                        	<a class="userCenter-link bus_look"  href="${mediaserver}imageservice?mediaImageId=${companyInfo.businessLicenceMediaId!}&mediaType=video" target="_blank">查看</a>
                    ...
                    <tr>
                        ...
                        <td>
                        	<a class="userCenter-link tax_look"  href="${mediaserver}imageservice?mediaImageId=${companyInfo.taxRegistrationCertificateMediaId!}&mediaType=video" target="_blank">查看</a>
