<script id="template-table-metric" type="text/x-kendo-template">
	<table>
	    ...
	    <tr>
	        <td class="monitor-tabWrap-td">质押覆盖率</td>
	        # for(var i=0;i<totalNum;i++){ #
...
<script id="template-table-data" type="text/x-kendo-template">
	<table>
	    ...
	    <tr>
	        <td class="monitor-tabWrap-td">当日已使用额度</td>
	         # for(var i=0;i<totalNum;i++){ #
	        	<td>#=data[i].usedLimitTheDay==null?"-":data[i].usedLimitTheDay.formatMoney()#</td>
	        # } #
	    </tr>
	    <tr>
	    ...
	    <tr>
	        <td class="monitor-tabWrap-td">机票销售总金额</td>
	         # for(var i=0;i<totalNum;i++){ #
	        	<td>#=data[i].ticketAllSales==null?"-":data[i].ticketAllSales.formatMoney()#</td>
	        # } #
	    </tr>
	    <tr>
