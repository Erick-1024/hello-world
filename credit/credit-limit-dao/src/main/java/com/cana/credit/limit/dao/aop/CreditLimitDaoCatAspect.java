package com.cana.credit.limit.dao.aop;
...
@Aspect
public class CreditLimitDaoCatAspect extends AbstractCatMonitorAspect {

	@Override
	@Pointcut("execution(* com.cana.credit.limit.dao.mapper..*.*(..))")
