package com.cana.credit.generate.whites.job.service;
 ...
 * 系统根据规则生成白名单
 * @author tangyihong
 * @deprecated 已经移动到 credit-scheduler
 */
@Service
public class GenerateWhitesService {
	
	private static final Logger logger = LoggerFactory.getLogger(GenerateWhitesService.class);
	 ...
	 * 2016年1月16日 - 2个月 = 2015年11月1日（保证有11月份，12月份2个足月）
	 * @param period
	 * @return
	 */
