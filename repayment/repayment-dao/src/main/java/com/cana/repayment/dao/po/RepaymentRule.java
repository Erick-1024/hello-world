...
public class RepaymentRule implements Serializable {
    ...
    public void setFianceCustomerIds(String fianceCustomerIds) {
        this.fianceCustomerIds = fianceCustomerIds == null ? null : fianceCustomerIds.trim();
    }
    ...
    public void setFianceCustomerCompanys(String fianceCustomerCompanys) {
        this.fianceCustomerCompanys = fianceCustomerCompanys == null ? null : fianceCustomerCompanys.trim();
    }
    ...
    public boolean equals(Object that) {
        ...
        RepaymentRule other = (RepaymentRule) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            && (this.getFactorId() == null ? other.getFactorId() == null : this.getFactorId().equals(other.getFactorId()))
            && (this.getFianceCustomerIds() == null ? other.getFianceCustomerIds() == null : this.getFianceCustomerIds().equals(other.getFianceCustomerIds()))
            && (this.getFianceCustomerCompanys() == null ? other.getFianceCustomerCompanys() == null : this.getFianceCustomerCompanys().equals(other.getFianceCustomerCompanys()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getFianceCustomerIds() == null) ? 0 : getFianceCustomerIds().hashCode());
        result = prime * result + ((getFianceCustomerCompanys() == null) ? 0 : getFianceCustomerCompanys().hashCode());
