...
public class RepaymentLoanInfoSnapshot implements Serializable {
    /**
     *放款信息快照Id
     */
    private String id;
     ...
     *还款计划版本
     */
    private String repaymentPlanExpenseVersion;
     ...
     *还款计划版本
     */
    public String getRepaymentPlanExpenseVersion() {
        return repaymentPlanExpenseVersion;
    }

    /**
     *还款计划版本
     */
    public void setRepaymentPlanExpenseVersion(String repaymentPlanExpenseVersion) {
        this.repaymentPlanExpenseVersion = repaymentPlanExpenseVersion == null ? null : repaymentPlanExpenseVersion.trim();
    }
    ...
    public boolean equals(Object that) {
        ...
        RepaymentLoanInfoSnapshot other = (RepaymentLoanInfoSnapshot) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            ...
            && (this.getRepaymentPlanExpenseVersion() == null ? other.getRepaymentPlanExpenseVersion() == null : this.getRepaymentPlanExpenseVersion().equals(other.getRepaymentPlanExpenseVersion()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getRepaymentPlanExpenseVersion() == null) ? 0 : getRepaymentPlanExpenseVersion().hashCode());
