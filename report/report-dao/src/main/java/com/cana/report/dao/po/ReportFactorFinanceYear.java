...
public class ReportFactorFinanceYear implements Serializable {
    /**
     *报表id
     */
    private String id;
     ...
     *累计展期金额
     */
    public void setTotalExtension(Long totalExtension) {
    ...
    public boolean equals(Object that) {
        ...
        ReportFactorFinanceYear other = (ReportFactorFinanceYear) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            ...
            && (this.getTotalOverdue() == null ? other.getTotalOverdue() == null : this.getTotalOverdue().equals(other.getTotalOverdue()))
            && (this.getTotalExtension() == null ? other.getTotalExtension() == null : this.getTotalExtension().equals(other.getTotalExtension()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getTotalOverdue() == null) ? 0 : getTotalOverdue().hashCode());
        result = prime * result + ((getTotalExtension() == null) ? 0 : getTotalExtension().hashCode());
