...
class SlaveStatu:
    ...
    def __init__(self,*args,**kwargs):
        ...
        if not kwargs["defaults_file"] is None:
            self.__read_defaults_file__( kwargs["defaults_file"] )
...
if __name__ == '__main__':
    ...
    opt.add_option("","--defaults-file",dest="defaults_file", default="default.conf",help="config file path")
