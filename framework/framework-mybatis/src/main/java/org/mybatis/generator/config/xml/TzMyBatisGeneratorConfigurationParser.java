 ...
 * @author Jeff Butler
 */
public class TzMyBatisGeneratorConfigurationParser {
    private Properties properties;

    public TzMyBatisGeneratorConfigurationParser(Properties properties) {
        super();
        if (properties == null) {
    ...
    public TzConfiguration parseConfiguration(Element rootNode)
            throws XMLParserException {

        TzConfiguration configuration = new TzConfiguration();
    ...
    private void parseProperties(TzConfiguration configuration, Node node)
            throws XMLParserException {
    ...
    private void parseContext(TzConfiguration configuration, Node node) {
        ...
        TzContext context = new TzContext(mt);
        context.setId(id);
    ...
    private void parseClassPathEntry(TzConfiguration configuration, Node node) {
        Properties attributes = parseAttributes(node);
