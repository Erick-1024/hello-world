 ...
 * @author Jeff Butler
 */
public class TzIbatorConfigurationParser {
    private Properties properties;

    public TzIbatorConfigurationParser(Properties properties) {
        super();
        if (properties == null) {
    ...
    public TzConfiguration parseIbatorConfiguration(Element rootNode)
    ...
    private void parseIbatorContext(TzConfiguration configuration, Node node) {
