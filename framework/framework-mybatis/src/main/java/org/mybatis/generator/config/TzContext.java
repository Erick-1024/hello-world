...
import org.mybatis.generator.internal.TzObjectFactory;
import org.mybatis.generator.internal.db.ConnectionFactory;
import org.mybatis.generator.internal.db.DatabaseIntrospector;
import org.mybatis.generator.internal.db.TzDatabaseIntrospector;

/**
 * @author Jeff Butler
 */
public class TzContext extends Context {
    private String id;
    ...
    private TzJavaFormatter javaFormatter;
    
    private TzXmlFormatter xmlFormatter;
     ...
     *            - may be null
     */
    public TzContext(ModelType defaultModelType) {
    ...
    public void validate(List<String> errors) {
        ...
        try {
            it = TzObjectFactory.createIntrospectedTableForValidation(this);
        } catch (Exception e) {
    ...
    public CommentGenerator getCommentGenerator() {
        if (commentGenerator == null) {
            commentGenerator = TzObjectFactory.createCommentGenerator(this);
        }

        return commentGenerator;
    }

    public TzJavaFormatter getTzJavaFormatter() {
        if (javaFormatter == null) {
            javaFormatter = TzObjectFactory.createJavaFormatter(this);
        }

        return javaFormatter;
    }
    
    public TzXmlFormatter getTzXmlFormatter() {
        if (xmlFormatter == null) {
            xmlFormatter = TzObjectFactory.createXmlFormatter(this);
        }
    ...
    public void introspectTables(ProgressCallback callback,
        ...
        try {
            ...
            TzDatabaseIntrospector databaseIntrospector = new TzDatabaseIntrospector(
