 ...
 * @author Jeff Butler
 */
public class TzDatabaseIntrospector {

    private DatabaseMetaData databaseMetaData;
    private JavaTypeResolver javaTypeResolver;
    private List<String> warnings;
    private TzContext context;
    private Log logger;

    public TzDatabaseIntrospector(TzContext context,
    ...
    private Map<ActualTableName, List<IntrospectedColumn>> getColumns(
        ...
        while (rs.next()) {
            IntrospectedColumn introspectedColumn = TzObjectFactory
    ...
    private List<IntrospectedTable> calculateIntrospectedTables(
        ...
        for (Map.Entry<ActualTableName, List<IntrospectedColumn>> entry : columns
            ...
            IntrospectedTable introspectedTable = TzObjectFactory
