...
public interface MailServer {
   ...
   void sendBuffered(Mailable email) throws MessagingException;
     ...
     * @throws MessagingException
     */
    void send(Mailable email,ArrayList<HashMap<String,String>> file_list) throws MessagingException;
