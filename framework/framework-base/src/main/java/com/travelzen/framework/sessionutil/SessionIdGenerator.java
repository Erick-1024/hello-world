 ...
 */
package com.travelzen.framework.sessionutil;
	...
	private SecureRandom createSecureRandom() {
		...
		if (secureRandomClass != null) {
			try {
				...
				logger.error("sessionIdGenerator.random" + secureRandomClass, e);
			}
		}
		...
		if (result == null) {
			...
			try {
				...
				logger.error("sessionIdGenerator.randomAlgorithm"
						+ secureRandomAlgorithm, e);
			} catch (NoSuchProviderException e) {
				logger.error("sessionIdGenerator.randomProvider"
		...
		if ((t2 - t1) > 100)
			logger.info("sessionIdGenerator.createRandom"
