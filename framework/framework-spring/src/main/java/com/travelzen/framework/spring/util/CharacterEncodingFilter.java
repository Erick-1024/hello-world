...
package com.travelzen.framework.spring.util;
...
//			log_.info("servletPathTmp="+servletPathTmp);
			String servletPath = servletPathTmp.substring(servletPathTmp.lastIndexOf("/")+1);
//			log_.info("servletPath="+servletPath);
//			log_.info("gbkEncodingUrl="+gbkEncodingUrl);
