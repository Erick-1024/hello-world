...
$(document).ready(function(){
    ...
    $(".confirm-link").click(function(){submitCompany()});
    $.ajax({  
        async : false,  
        cache:false,  
        type: 'POST',  
        ...
        url: "getEditPermissionsTreeForCompany",
...
function submitCompany()
{
	...
	else
	{
	    $.ajax({
	        type: 'POST',  
	        url: "updateCompanyRole",
	        data: {roleId:$("#roleName").data("roleid"),roleName:$("#roleName").val(),userType:$("#userType").val(),"permissions":permissions},
	        error: function (data) { 
	        	$(".k-i-close").click();
//	        	showAlertWin("网络异常："+data.responseText);
	        	showAlertWin("网络异常!");
