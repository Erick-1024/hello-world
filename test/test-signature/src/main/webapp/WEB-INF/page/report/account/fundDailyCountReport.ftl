...
<@hb.htmlBase title="资金计数表" 
			  jsFiles=["page/report/account/fundDailyCountReport.js","common/cana.util.js"] 
			  cssFiles=["css/reports.css"] 
              localCssFiles=[] 
              curTopMenu = "统计报表" curSubMenu = "资金计数表" removeExtHeader = false removeExtFooter = false>
<div class="main-container">
	<div class="whiteBg">
        ...
        <div class="reprots-grid" id="reprots-finCountGrid" style="margin-top:15px;"></div>
    </div>
</div>
</@hb.htmlBase>