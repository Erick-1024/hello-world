...
<@hb.htmlBase title="线下还款" jsFiles=["page/repayment/offline/repaymentPlanAdjustment.js","common/formValidator.js","page/repayment/offline/repaymentPlanAdjustmentRules.js"] cssFiles=["css/finance.css"] localCssFiles=[] curTopMenu = "融资管理" curSubMenu = "融资信息管理" removeExtHeader = false removeExtFooter = false>
        ...
        <section class="repayment-manual">
            ...
            <div class="repayment-grid" id="repayment-plan">
                ...
                <div class="finance-item">
                    <label>本次还款总金额</label><input name="chargeForAutoAllocation" type="text" placeholder="￥" class="moneyNum"><a id="autoAllocationCharge" class="form-add-link addRepayCost" href="javascript:void(0);">自动分配</a>
                    <#if authorizeKey("FM_REPAYMENTINFO_MANAGE_REPAYMENTDETAILSHISTORY")>
                    	<a class="repayment-link repayDetail-link" href="javascript:void(0);">历史还款明细</a>
                    </#if>
                </div>
            ...
            <div class="dlg-wrapper-foot" id="foot-fixBar">
				...
				<form id="repaymentPlanAndExpense" action="savePlanAndExpenseSummaryAndDetail" method="post">
					...
					<input type="hidden" name="changeType" value="offline_repayment">
				</form>
