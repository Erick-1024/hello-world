<div class="userCenter-content">
                <table>
                    ...
                    <tr>
                        <td>所属角色</td>
                        <td>${individualInfo.roleName!''}</td>
                        <td>
                            <a class="userCenter-link" href="${basepath}/user/gotoCompanyRoleDetails?roleId=${individualInfo.roleId!''}&type=individual" target="_blank">详情</a>
                        </td>
                    </tr>
                    <tr>
                        <td>登录密码</td>
