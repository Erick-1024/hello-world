...
<@hb.htmlBase title="融资客户确认" jsFiles=["page/guide/signContract.js"] cssFiles=[] localCssFiles=[] 
	        ...
	        <div class="finaConfirm-content">
	            <div class="finaLeadCheck">
	                ...
	                <label class="checkboxInfo">
	                    <span class="checkbox"></span>阅读并签署《<a id="readContract" download="Cana金融合同" class="repayment-link">应收款债权转让协议</a>》
	                </label>
	            </div>
