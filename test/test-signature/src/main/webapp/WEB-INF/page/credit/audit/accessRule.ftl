        ...
        <div class="relieve-wrap">
            ...
            <div class="monitorChk-content">
                <table class="monitorChk-tab">
                    ...
                    <tr>
                        <td class="registionRow-til">是否检查真旅网评审结果通过</td>
                        <td>${accessRule.isCheckProposalAuditResult!}</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>${accessRule.downstreamRepaymentAccountPeriod!}</td>
                    </tr>
                    <tr>
            ...
            <div class="monitorChk-content">
                <table class="monitorChk-tab">
                    ...
                    <tr>
                        <td class="registionRow-til">是否检查工商信息真实</td>
                        <td>${accessRule.isCheckBusinessInfomation!}</td>
                    </tr>
                    <tr>
                        <td class="registionRow-til">是否检查负面信息</td>
                        <td>${accessRule.isCheckNegativeInfomation!}</td>
                    </tr>
                    </tbody>
                </table>
            </div>
