...
<@hb.htmlBase title="提交审核" jsFiles=[] cssFiles=["css/login.css"] localCssFiles=[] removeExtHeader = true>
...
<div class="main-registion">
    <div class="activate-wrap">
        <div class="activate-title">账户注册</div>
        <div class="activate-content">
            <div class="activate-cnt-head">注册信息提交成功！</div>
            <div class="activate-row">&nbsp;</span></div>
            <div class="activate-backrow">您的账户注册申请已提交，</br>审核结果将发送至您的邮箱，请注意查收！</div>
            <div class="activate-foot">
                <a class="activate-link" href="${basepath}/facade/signin">确 定</a>
            </div>
        </div>
    </div>
</div>
