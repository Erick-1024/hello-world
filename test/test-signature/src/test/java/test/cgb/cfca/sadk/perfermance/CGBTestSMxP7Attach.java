 ...
 * 
 */
public final class CGBTestSMxP7Attach extends CGBTestFrame {
    ...
    public static void main(String[] args) throws Exception {
        CGBTestFrame.runTest(new CGBTestSMxP7Attach(), true, args);
    }

    @Override
    final String signedMessage(String message) throws UnsupportedEncodingException, PKIException {
        return castle.signData(Mechanism.SM3_SM2, message);
    }
