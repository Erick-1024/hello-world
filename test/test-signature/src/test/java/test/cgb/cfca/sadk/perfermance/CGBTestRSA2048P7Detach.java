 ...
 * 
 */
public class CGBTestRSA2048P7Detach extends CGBTestFrame {
    ...
    public static void main(String[] args) throws Exception {
        CGBTestFrame.runTest(new CGBTestRSA2048P7Detach(), true, args);
    }

    @Override
    final String signedMessage(String message) throws UnsupportedEncodingException, PKIException {
        return castle.signDataDetached(Mechanism.SHA256_RSA, message);
    }
