...
public class P10RequestTestCase extends TestCase {
    ...
    public void testLoadByteArray() throws PKIException {
        ...
        p10Request = new P10Request(session);
        p10Request.load(base64P10ICBC_3.getBytes());
        assertTrue("testLoadByteArray", p10Request.getSignature().length == 64);
    ...
    public void testLoadCertificationRequest() throws PKIException {
        ...
        p10Request = new P10Request(session);
        certificationRequest = CertificationRequest.getInstance(Base64.decode(base64P10CFCA));
        p10Request = new P10Request(session);
        p10Request.load(certificationRequest);
        assertTrue("testLoadCertificationRequest", true);

        p10Request = new P10Request(session);
        certificationRequest = CertificationRequest.getInstance(Base64.decode(base64P10ICBC));
        p10Request = new P10Request(session);
        p10Request.load(certificationRequest);
        assertTrue("testLoadCertificationRequest", true);
    ...
    final void callGenerateDoublePKCS10RequestMechanismIntSession(final Mechanism mechanism, int kLength) throws PKIException {
        ...
        assertTrue("testGenerateDoublePKCS10RequestMechanismIntSession[" + mechanism + "]", p10Request.getPrivateKey() != null);
        sm2CheckedSignedASNBytes(p10Bytes, mechanism);
    ...
    final void callGeneratePKCS10RequestMechanismX500NameASN1SetPublicKeyPrivateKey(final Mechanism mechanism, int kLength) throws PKIException {
        ...
        p10Bytes = p10Request.generatePKCS10Request(mechanism, holder, null, publicKey, privateKey);
        assertTrue("callGeneratePKCS10RequestMechanismX500NameASN1SetPublicKeyPrivateKey[" + mechanism + "]", p10Bytes != null && p10Bytes.length > 0);
    }
    ...
    final void callGeneratePKCS10RequestMechanismX500NameASN1SetPublicKeyByteArray(final Mechanism mechanism, int kLength) throws PKIException, IOException {
        ...
        if (smFalg) {
            assertTrue("callGeneratePKCS10RequestMechanismX500NameASN1SetPublicKeyByteArray[" + mechanism + "]", signature.length > 64);
        }
    ...
    final void callGeneratePKCS10RequestMechanismCertificationRequestInfoByteArray(final Mechanism mechanism, int kLength) throws PKIException, IOException {
        ...
        if (smFalg) {
            assertTrue("callGeneratePKCS10RequestMechanismCertificationRequestInfoByteArray[" + mechanism + "]", signature.length > 64);
        }
    ...
    final void callGenerateCertificationRequestInfo(final Mechanism mechanism, int kLength) throws PKIException, IOException {
        ...
        if (smFalg) {
            assertTrue("callGenerateCertificationRequestInfo[" + mechanism + "]", signature.length > 64);
        }
    ...
    public void testGenerateCertificationRequest() throws PKIException, IOException {
        if (generatedRSA2048Flag) {
            callGenerateCertificationRequest(new Mechanism(Mechanism.SHA256_RSA), 2048);
        }
        callGenerateCertificationRequest(new Mechanism(Mechanism.SHA256_RSA), 1024);
        callGenerateCertificationRequest(new Mechanism(Mechanism.SHA512_RSA), 1024);
        callGenerateCertificationRequest(new Mechanism(Mechanism.SHA1_RSA), 1024);

        callGenerateCertificationRequest(new Mechanism(Mechanism.SM3_SM2), 256);
    }

    final void callGenerateCertificationRequest(final Mechanism mechanism, int kLength) throws PKIException, IOException {
        P10Request p10Request = new P10Request(session);
        ...
        String base64CertificationRequest = p10Request.generateCertificationRequest(mechanism, holder, attributes, publicKey, privateKey);

        byte[] p10Bytes = Base64.decode(base64CertificationRequest);

        CertificationRequest certRequest = CertificationRequest.getInstance(p10Bytes);
        assertTrue("callGenerateCertificationRequest[" + mechanism + "]", certRequest != null);

        p10Request = new P10Request(session);
        p10Request.load(p10Bytes);

        assertTrue("callGenerateCertificationRequest[" + mechanism + "]", p10Bytes != null && p10Bytes.length > 0);
        assertTrue("callGenerateCertificationRequest[" + mechanism + "]", p10Request.getTemporaryKeyPair() == null);

        sm2CheckedSignedASNBytes(base64CertificationRequest.getBytes(), mechanism);
    }
    ...
    final void callParseCertificationRequestInfoToBytes(final Mechanism mechanism, int kLength) throws PKIException, IOException {
        ...
        if (smFalg) {
            assertTrue("callParseCertificationRequestInfoToBytes[" + mechanism + "]", signature.length > 64);
        }
    ...
    public void testGetCertReqType() throws PKIException {
        ...
        for (int i = 0; i < p10TextsTable.length; i++) {
            ...
            assertTrue("testGetCertReqType", p10Request.getCertReqType() == 1);// 双证
    ...
    final void callGetCertReqType(final Mechanism mechanism, int kLength) throws PKIException {
        ...
        assertTrue("callGetCertReqType[" + mechanism + "]", p10DoubleRequest.getCertReqType() == 1);// 双证
        ...
        assertTrue("callGetCertReqType[" + mechanism + "]", p10SingleRequest.getCertReqType() == 0);// 单证
