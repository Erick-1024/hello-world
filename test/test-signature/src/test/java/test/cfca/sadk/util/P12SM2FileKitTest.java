...
public final class P12SM2FileKitTest {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String base64SM2 = P12FileKit.RSACombineP12(base64EncryptedKeyData, base64CertData, password);

        String outFile = "c:/tmp/test.sm2";
        FileHelper.write(outFile, Base64.decode(base64SM2));

        PrivateKey privateKey = KeyUtil.getPrivateKeyFromSM2(outFile, password);

        X509Cert cert = CertUtil.getCertFromSM2(outFile);
