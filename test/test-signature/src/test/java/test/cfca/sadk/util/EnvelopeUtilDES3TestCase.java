 ...
 *
 */
public class EnvelopeUtilDES3TestCase extends EnvelopeUtilTestCase {
    ...
    protected void setUp() throws Exception {
        ...
        encryptFilePath = "./TestData/envelopes/test.des3.enc";

        sourceData = FileHelper.read(sourceFilePath);
        cmsEnvelopedDataBase64 = FileHelper.read( "./TestData/envelopes/test.des3.msg");
