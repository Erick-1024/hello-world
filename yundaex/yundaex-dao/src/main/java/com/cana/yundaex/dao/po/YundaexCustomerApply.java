...
public class YundaexCustomerApply implements Serializable {
    /**
     *主键
     */
    private String id;
     ...
     *借款期限
     */
    private Integer shortLoanLimit;
     ...
     *借款期限
     */
    public Integer getShortLoanLimit() {
        return shortLoanLimit;
    }

    /**
     *借款期限
     */
    public void setShortLoanLimit(Integer shortLoanLimit) {
        this.shortLoanLimit = shortLoanLimit;
    }
     ...
     *计算额度时，存放额度信息
     */
    public String getLimitInfoRemarks() {
        return limitInfoRemarks;
    }

    /**
     *计算额度时，存放额度信息
     */
    public void setLimitInfoRemarks(String limitInfoRemarks) {
        this.limitInfoRemarks = limitInfoRemarks == null ? null : limitInfoRemarks.trim();
    }
    ...
    public boolean equals(Object that) {
        ...
        YundaexCustomerApply other = (YundaexCustomerApply) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            ...
            && (this.getShortLoanLimit() == null ? other.getShortLoanLimit() == null : this.getShortLoanLimit().equals(other.getShortLoanLimit()))
            ...
            && (this.getBailRatio() == null ? other.getBailRatio() == null : this.getBailRatio().equals(other.getBailRatio()))
            ...
            && (this.getLimitInfoRemarks() == null ? other.getLimitInfoRemarks() == null : this.getLimitInfoRemarks().equals(other.getLimitInfoRemarks()))
            && (this.getApplyType() == null ? other.getApplyType() == null : this.getApplyType().equals(other.getApplyType()))
            && (this.getNotifyFlag() == null ? other.getNotifyFlag() == null : this.getNotifyFlag().equals(other.getNotifyFlag()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getShortLoanLimit() == null) ? 0 : getShortLoanLimit().hashCode());
        ...
        result = prime * result + ((getBailRatio() == null) ? 0 : getBailRatio().hashCode());
        ...
        result = prime * result + ((getLimitInfoRemarks() == null) ? 0 : getLimitInfoRemarks().hashCode());
        result = prime * result + ((getApplyType() == null) ? 0 : getApplyType().hashCode());
        result = prime * result + ((getNotifyFlag() == null) ? 0 : getNotifyFlag().hashCode());
