...
public class ReportFactorFinanceYearDTO implements Serializable{
	/**
	 * 
	 */
	private static final long serialVersionUID = -6918020577304822051L;
	...
	public String getTotalExtension() {
		return totalExtension;
	}

	public void setTotalExtension(String totalExtension) {
