 ...
 *
 */
public class CanaReportAccountFundDTO implements Serializable, Comparable<CanaReportAccountFundDTO> {

	private static final long serialVersionUID = 71974069321154315L;
	...
	@Override
	public int compareTo(CanaReportAccountFundDTO o) {
